...
Packages = c('dplyr', 'data.table', 'magrittr', 'caret', 'pastecs', 'vegan', 'kernlab', 'pls', 'factoextra', 'htmltools') 
...
test_pc_result5 <- predict(train_pca_result, newdata = test_n[, -1])[,1:5] %>% as.data.frame()%>%cbind(test_n %>% dplyr::select(critical_temp))
```
